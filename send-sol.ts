...
const recipient = new PublicKey("DimaWWyAW2JBrHoESaYeFTmmzpUeuRUMcqwdox1iWxmp");
...
// додайте наступне зразу після 'transaction.add(sendSolInstruction)'...
...
const memoText = "Hello from Yurii!";
